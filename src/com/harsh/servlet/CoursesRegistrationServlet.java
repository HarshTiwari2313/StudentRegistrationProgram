...
public class CoursesRegistrationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		    ...
		    out.println("<html>");
		    out.println("<body>");
		    out.println("<h2 style='color:red;' align='center'>Harsh Student Registration Application</h2> ");
		    out.println("<h3 style='color:blue;' align='center'>Student Courses Registration</h3>");
